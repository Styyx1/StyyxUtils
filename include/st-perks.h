...
struct PerkUtil
{
    ...
    static void TraversePerkNode(RE::BGSSkillPerkTreeNode* node, std::unordered_set<RE::BGSPerk*>& set_out,
  ...
  private:
    static constexpr std::array<RE::ActorValue, 6> kWarriorSkills = {
        RE::ActorValue::kOneHanded, RE::ActorValue::kTwoHanded, RE::ActorValue::kHeavyArmor,
        RE::ActorValue::kArchery,   RE::ActorValue::kSmithing,  RE::ActorValue::kBlock};
    static constexpr std::array<RE::ActorValue, 6> kThiefSkills = {
        RE::ActorValue::kSpeech, RE::ActorValue::kAlchemy,    RE::ActorValue::kLockpicking,
        RE::ActorValue::kSneak,  RE::ActorValue::kPickpocket, RE::ActorValue::kLightArmor};
    static constexpr std::array<RE::ActorValue, 6> kMageSkills = {
        RE::ActorValue::kAlteration, RE::ActorValue::kConjuration, RE::ActorValue::kDestruction,
        RE::ActorValue::kIllusion,   RE::ActorValue::kEnchanting,  RE::ActorValue::kRestoration};
